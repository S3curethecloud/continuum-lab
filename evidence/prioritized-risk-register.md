...
Generated: 2026-06-23T03:01:36.006747+00:00

| Priority | Score | Finding | Severity | Service | Type | Validation | Summary |
|---|---:|---|---|---|---|---|---|
| P0 | 100 | FIND-001 | high | customer-api | sql_injection | pending_validation | +70: base severity is high; +10: environment is prod-like; +15: service is internet reachable; +10: service is in a production path |
| P0 | 100 | FIND-003 | medium | customer-api | secret_detection | likely_test_fixture | +45: base severity is medium; +10: environment is prod-like; +15: service is internet reachable; +10: service is in a production path |
